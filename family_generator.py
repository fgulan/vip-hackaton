...
feature_generator_parameters_type_0 = [ # Family
    ...
    0.5,   0.002,     0.002,  0.0009,
    0.49,  0.00015,   0.0015, 0.00001,
    0.489, 0.0002,    0.002,  0.002,
    0.51,  0.00009,   0.0001, 0.0015,
    0.53,  0.00012,   0.0025, 0.0001,
    0.52,  0.00001,   0.001,  0.002,
    0.35,  0,         0.002,  0.0013,

    # Minutes parameters [3, 30 * 60] in seconds
    2*60,      45,    0.002,  0.0009,
    3*60,      48,    0.0015, 0.00001,
    2*60 + 20, 32,    0.002,  0.002,
    2*60 + 45, 50,    0.0001, 0.0015,
    3*60 - 10, 28,    0.0025, 0.0001,
    2*60 + 21, 40,    0.001,  0.002,
    80,        20,    0.002,  0.0013,
...
family, fam_labels = generate_dataset(10, 0)
non_family, labels = generate_dataset(10, 1)
